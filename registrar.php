...
try {
    ...
    // ── Asignar plan Free por 30 días automáticamente ────────────
...
$stmt = $db->prepare("
    ...
    VALUES (?, 'free', 'mensual', 'activo', 0, ?, ?, 'Plan gratuito de bienvenida - 30 días')
");
$stmt->execute([$restaurante_id, $fechaActivacion, $fechaVencimiento]);
